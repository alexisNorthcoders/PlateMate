    ...
    <div className='bg-conifer-950 p-2'>
      <nav>
        <ul className='flex justify-between items-center'>
          <li> <Link className='btn bg-conifer-700 hover:bg-conifer-800 active:bg-conifer-900' to={loggedIn ? "Home" : "/"}>Home</Link></li>
        {loggedIn && <> <li> <Link className='btn bg-conifer-700 hover:bg-conifer-800 active:bg-conifer-900' to={`Calendar`}>Calendar</Link></li>
          <li> <Link className='btn bg-conifer-700 hover:bg-conifer-800 active:bg-conifer-900' to={`Chat`}>Chat</Link></li>
          <li> <Link className='btn bg-conifer-700 hover:bg-conifer-800 active:bg-conifer-900' to={`Profile`}>Profile</Link></li>
