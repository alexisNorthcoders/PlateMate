    ...
    return (
        ...
        <div className="container mx-auto flex items-center">
          ...
          <div className="w-1/2 ml-5 text-center">
            ...
            <button className="text-base lg:text-lg xl:text-xl 2xl:text-2xl bg-conifer-600 hover:bg-conifer-700 active:bg-conifer-950 text-white font-bold py-3 px-6 rounded-full shadow-lg transition duration-300 ease-in-out">Learn More</button>
          </div>
        </div>
