...
export const MyMeals = () => {
    ...
    return (<>
        {meals && meals.map((meal, index) => {
            return (
                <article key={index} className="w-[230px] text-black p-0.5 mx-2 my-4 max-w-sm bg-gradient-to-br from-teal-200 via-teal-600 to-teal-900 rounded-lg shadow-lg items-center h-full">
